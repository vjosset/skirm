...
|`SCx`|**Save Critical x**|When this Agent rolls Saves (when it is the target of a combat attack for example), rolls of `x` or lower are treated as Critical and trigger a Critical Chain.|
